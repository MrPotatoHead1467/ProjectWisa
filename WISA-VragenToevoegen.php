        ...
        <table class="Vragen_Toevoegen_Table">
          <tr>
            <td class="Vragen_Toevoegen_Td">
                ...
                <input class="form_newvraag_in" id="Nieuwe_vraag" type="text" name="Nieuwe_vraag" <?php echo "value='".$_SESSION['Nieuwe_vraag']."'"?> required="True" class="Nieuwe_vraag"/>
            </td>
            <td class="Vragen_Toevoegen_Td">
                <!-- Kernwoord toevoegen -->
                <label class="form_newvraag_lbl" for="Kernwoord_vraag">Kernwoord vraag:</label><br />
                <input id="Kernwoord_vraag" type="text" name="Kernwoord_vraag" <?php echo "value='".$_SESSION['Kernwoord_vraag']."'"?> required="True"/>
            </td>
          </tr>
          <tr>
            <td class="Vragen_Toevoegen_Td">
          ...
          <tr>
            ...
            <td class="Vragen_Toevoegen_Td">
                <div id="GepersonaliseerdeLijst" class="GepersonaliseerdeLijst">
                    ...
                    <label class="form_newvraag_lbl" for="Mogelijk_antwoord">Geef een mogelijk antwoord in:</label>
                </div>
            </td>
            <td class="Vragen_Toevoegen_Td">
          ...
          <tr>
            <td class="Vragen_Toevoegen_Td">
                ...
                <div id="Max_aantal_antwoorden" class="Max_antwoord">
                    <label class="form_newvraag_lbl" for="Max_antwoord">Maximaal aantal antwoorden:</label>
        ...
        function bestaandelijst()
            {
                ...
                document.getElementById('GepersonaliseerdeLijstAntwoord').style.display = 'none'
