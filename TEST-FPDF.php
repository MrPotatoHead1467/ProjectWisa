...
<?php
            ...
            function Footer()   
                {
                    ...
                    $this -> cell(170, 5, 'SCHOOLNAAM | Inschrijving voornaam achternaam', 0, 0);
    ...
    $pdf -> cell(5, 5, '', 0, 0);
    $pdf -> cell(185, 5, 'Inschrijvingsdatum: datum', 0,1,'L');
    $pdf -> cell(5, 5, '', 0, 0);
    $pdf -> cell(185, 5, 'Ingeschreven door: Voornaam Achternaam', 0,1,'L');
    $pdf -> cell(5, 5, '', 0, 0);
    $pdf -> cell(185, 5, 'Laatst aangepast: datum2', 0,1,'L');
    $pdf -> Ln(5);
