...
<body>
    ...
    <div>
        <form action="AddLeerling.php" method="post" enctype="multipart/form-data">
            ...
            <label class='form_lbl'>Inschrijvingen goedkeuren</label><br />
                <?php
                ...
                for ($i = 1; $i <= 4; $i++){
                    $sqlInschrijvingen = "SELECT * FROM tbl_inschrijvingen
                                          WHERE fld_inschrijving_status_id_fk=".$i."
                                          ORDER BY fld_inschrijving_datum ASC";
                        ...
                        if ($resultInschrijvingen->num_rows > 0) 
                            {
                                while($rowInschrijvingen = $resultInschrijvingen->fetch_assoc())
                                    ...
                                    if ($infoVoorwaarden->num_rows > 0)
                                        ...
                                        // Alle ingeschreven leerlingen worden afgebeeld met de datum van inschrijving
                                        echo "<tr>";
                                            echo "<div>";
                                                echo "<button type='button' onclick='Open(&#34;".$lln['ID']."&#34;)'>".$inschrijvingGeg['DATUM']." | ".$lln['NAAM']."</button>";
                                                echo "<div id='Knoppen_".$lln['ID']."' style='display: none;'>";
                                                    if ($rowInschrijvingen['fld_inschrijving_status_id_fk'] != 2){
                                            ...
                                            // Alle gegevens van de leerling worden geladen maar zijn pas zichtbaar wanneer er op de knop hierboven geklikt wordt
                                            echo "<div class='form_box_1' id='Leerling_".$lln['ID']."' style='display: none;'>";
                                                echo "<label class='form_lbl'>Inschrijver: ".$inschrijvingGeg['NAAM']."</label><br />";
                                                echo "<label class='form_lbl'>Commentaar: ".$inschrijvingGeg['COMM']."</label><br /><br />";
                                                
                                                if  ($rowInschrijvingen['fld_inschrijving_status_id_fk'] != 1){
                                                    echo "<label class='form_lbl'>Laatste geüpdate: ".$inschrijvingGeg['UPDATE']."</label><br /><br />";
                                                }
                                               
                                                echo "<label class='form_lbl'>Geslacht: ".$lln['GESLACHT']."</label><br />";
                                                echo "<label class='form_lbl'>GBDatum: ".$lln['DATUM']."</label><br />";
                                                echo "<label class='form_lbl'>GBPlaats: ".$lln['GBPLAATS']."</label><br />";
                                                echo "<label class='form_lbl'>Nationaliteit: ".$lln['NATION']."</label><br />";
                                                
                                                if  ($lln['RIJKNR'] == ''){
                                                    echo "<label class='form_lbl'>Leerling Bisnr: ".$lln['BISNR']."</label><br />";
                                                }
                                                else {
                                                    echo "<label class='form_lbl'>Rijksregisternr: ".$lln['RIJKNR']."</label><br />";
                                                }
                                                
                                                echo "<label class='form_lbl'>Leerling Godsdienst: ".$lln['GODS']."</label><br /><br />";
                                                
                                                foreach ($gegLln as $Gegeven){
                                                    echo "<label class='form_lbl'>Soort: ".$Gegeven['SOORT']."</label><br />";
                                                    echo "<label class='form_lbl'>Gegeven: ".$Gegeven['GEG']."</label><br />";
                                                    echo "<label class='form_lbl'>Beschrijving: ".$Gegeven['BESCHR']."</label><br /><br />";
                                                }
                                                
                                                foreach ($adresLln as $Adres_Leerling){
                                                    echo "<label class='form_lbl'>Soort: ".$Adres_Leerling['SOORT']."</label><br />";
                                                    echo "<label class='form_lbl'>Straat: ".$Adres_Leerling['STRAAT']."</label><br />";
                                                    echo "<label class='form_lbl'>Huisnummer: ".$Adres_Leerling['HUIS']."</label><br />";
                                                    
                                                    if ($Adres_Leerling['BUS'] != ''){
                                                        echo "<label class='form_lbl'>Busnr: ".$Adres_Leerling['BUS']."</label><br />";
                                                    }
                                                    
                                                    echo "<label class='form_lbl'>Postcode: ".$Adres_Leerling['POST']."</label><br />";
                                                    echo "<label class='form_lbl'>Gemeente: ".$Adres_Leerling['PLAATS']."</label><br />";
                                                    echo "<label class='form_lbl'>Land: ".$Adres_Leerling['LAND']."</label><br />";
                                                    echo "<label class='form_lbl'>Beschrijving: ".$Adres_Leerling['BESCHR']."</label><br /><br />";
                                                }
                                                
                                                echo "<label class='form_lbl'>Ouder</label><br />";
                                                foreach ($gegR as $GegevenR){
                                                    echo "<label class='form_lbl'>Soort: ".$GegevenR['SOORT']."</label><br />";
                                                    echo "<label class='form_lbl'>Gegeven: ".$GegevenR['GEG']."</label><br />";
                                                    echo "<label class='form_lbl'>Beschrijving: ".$GegevenR['BESCHR']."</label><br /><br />";
                                                }
                                                
                                                foreach ($adresR as $Adres_R){
                                                    echo "<label class='form_lbl'>Soort: ".$Adres_R['SOORT']."</label><br />";
                                                    echo "<label class='form_lbl'>Straat: ".$Adres_R['STRAAT']."</label><br />";
                                                    echo "<label class='form_lbl'>Huisnummer: ".$Adres_R['HUIS']."</label><br />";
                                                    
                                                    if ($Adres_R['BUS'] != ''){
                                                        echo "<label class='form_lbl'>Busnr: ".$Adres_R['BUS']."</label><br />";
                                                    }
                                                    
                                                    echo "<label class='form_lbl'>Postcode: ".$Adres_R['POST']."</label><br />";
                                                    echo "<label class='form_lbl'>Gemeente: ".$Adres_R['PLAATS']."</label><br />";
                                                    echo "<label class='form_lbl'>Land: ".$Adres_R['LAND']."</label><br />";
                                                    echo "<label class='form_lbl'>Beschrijving: ".$Adres_R['BESCHR']."</label><br /><br />";
                                                }
                                                echo "<label class='form_lbl'>NAAM: ".$relatieLln['NAAM']."</label><br />";
                                                echo "<label class='form_lbl'>Geslacht: ".$relatieLln['GESLACHT']."</label><br />";
                                                echo "<label class='form_lbl'>GBDatum: ".$relatieLln['GEBOORTE']."</label><br />";
                                                echo "<label class='form_lbl'>Overleden: ".$relatieLln['OVER']."</label><br />";
                                                echo "<label class='form_lbl'>Beschrijving: ".$relatieLln['BESCHR']."</label><br />";                    
                                                                                                
                                                $relatieLln[$a] = array("SOORT"=>strtolower($SoortRLln), 
                                                                        "NAAM"=>$NaamRLln, 
                                                                        "GESLACHT"=>$GeslachtRLln, 
                                                                        "GEBOORTE"=>(date('d/m/Y', strtotime($GbRLln))), 
                                                                        "OVER"=>$OverledenRLln, 
                                                                        "BESCHR"=>$BeschrRLln, 
                                                                        "GEGR"=>$gegR, 
                                                                        "ADRESR"=>$adresR);
...
<!--
	function Open(id){
	   if (document.getElementById("Leerling_" + id).style.display == 'block'){
	       document.getElementById("Leerling_" + id).style.display = 'none';
           document.getElementById("Knoppen_" + id).style.display = 'none';
	   }
       else {
            document.getElementById("Leerling_" + id).style.display = 'block';
            document.getElementById("Knoppen_" + id).style.display = 'block';
       }
